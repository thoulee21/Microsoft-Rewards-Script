...
export default class BrowserUtil {
    ...
    async tryDismissAllMessages(page: Page): Promise<void> {
        const buttons = [
            ...
            {
                selector: '.ext-secondary.ext-button',
            ...
            {
                selector: '.ms-Button.ms-Button--primary',
                label: 'Primary Button',
            },
            {
                selector: '.c-glyph.glyph-cancel',
                label: 'Mobile Welcome Button',
            },
            { selector: '.maybe-later', label: 'Mobile Rewards App Banner' },
            {
                selector:
                    '//div[@id="cookieConsentContainer"]//button[contains(text(), "Accept")]',
                label: 'Accept Cookie Consent Container',
                isXPath: true,
            },
            ...
            if (!homeTab) {
                ...
                if (homeTabURL.hostname !== 'rewards.bing.com') {
                    throw this.bot.log(
                        this.bot.isMobile,
                        'GET-TABS',
                        'Reward page hostname is invalid: ' + homeTabURL.host,
                        'error'
                    )
                }
            }
